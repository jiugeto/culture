...
@section('content')
    ...
    <table class="table_create table_show" cellspacing="0" cellpadding="0">
        <tr>
            <td class="field_name" style="width:100px;">片源名称：</td>
            <td>{{ $data->name }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="field_name">预算：</td>
            <td>{{ $data->getMoney1() }}</td>
        </tr>
        <tr>
            <td class="field_name">供应列表：</td>
            <td>{{ count($data->getGoodCustoms()) }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="field_name">确定价格：</td>
            <td>{{ $data->getMOney2() }}</td>
        </tr>
        <tr>
