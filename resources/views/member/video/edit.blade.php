...
@section('content')
    ...
    <form data-am-validator method="POST" action="{{DOMAIN}}member/video/{{ $data->id }}" enctype="multipart/form-data">
        ...
        <table class="table_create">
            ...
            <tr>
                ...
                <td>
                    ...
                    <textarea placeholder="视频地址粘贴在这里，至少2个字符" minlegth="2" required name="url" cols="40" rows="5">{{ $data->url.'?'.$data->url2 }}</textarea>
