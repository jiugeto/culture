...
@section('content')
    ...
    <form data-am-validator method="POST" action="{{DOMAIN}}member/{{ $lists['func']['url'] }}" enctype="multipart/form-data">
        ...
        <table class="table_create">
            <tr>
                <td class="field_name"><label>设计名称{{-- / Name--}}：</label></td>
            ...
            <tr>
                <td class="field_name"><label>设计类型{{-- / cate--}}：</label></td>
                <td>
            ...
            <tr>
                <td class="field_name"><label>价格{{-- / Price--}}：(单位元)</label></td>
                <td><input type="text" placeholder="" pattern="^\d+(.\d{1,2})?$" required name="money"/></td>
            </tr>
            {{--<tr><td></td></tr>--}}

            <tr>
                <td class="field_name"><label>简介{{-- / Introduce--}}：</label></td>
                <td>
...
//                                    toolbars:[['redo','undo','bold','italic','underline','strikethrough','horizontal','forecolor','fontfamily','fontsize','priview','directionality','paragraph','searchreplace','pasteplain','help']]
            ...
            <tr>
                <td class="field_name"><label>详情{{-- / Detail--}}：</label></td>
