...
<style>
    ...
    .p_out a { padding:2px 10px;border:1px solid lightgrey;color:lightgrey;text-decoration:none;cursor:pointer; }
    .p_out a:hover/*,.p_out a.curr*/ { border:1px solid orangered;color:orangered; }
    .p_out input { padding:2px 5px;width:20px;border:1px solid darkgray;text-align:center;color:grey;font-size:18px;
        background:lightgrey;position:relative;top:-1px; }
