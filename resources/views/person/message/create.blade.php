        ...
        <div class="per_list">
            ...
            <form method="POST" action="{{DOMAIN}}person/message" enctype="multipart/form-data" class="list">
                ...
                <table class="tform">
                    <tr>
                        <td>接收人：</td>
                        <td><input type="text" style="width:400px;" placeholder="邮箱/QQ/用户名" name="name"></td>
                    </tr>
                    <tr>
                        <td>标题：</td>
                        <td><input type="text" style="width:400px;" placeholder="至少2个字符" name="title"></td>
                    </tr>
                    <tr>
                        <td>内容：</td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" style="text-align:center;">
                            ...
                            <button type="submit" name="nosend" class="companybtn">保存草稿</button>
                            <button type="submit" name="send" class="companybtn">开始发送</button>
                        </td>
                    </tr>
                </table>
            </form>
