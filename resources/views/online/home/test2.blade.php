...
@section('content')
    {{--内页的样式方便调节动画--}}
    <style>
        .img1 div.dh { margin:0 auto; padding-top:10px; width:960px; height:540px; overflow:hidden; position:relative; top:540px; opacity:1; }
    ...
    <div class="switch">
        ...
        <a href="/online"><button class="onlinebtn">重置</button></a>
    </div>
