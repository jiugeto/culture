...
<form data-am-validator method="POST" action="{{DOMAIN}}company/admin/{{$lists['func']['url']}}/{{ $data->id }}" enctype="multipart/form-data">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <input type="hidden" name="_method" value="POST">
    <table class="table_create">
        <tr>
            <td class="field_name"><label>{{$lists['func']['url']=='product'?'产品':'花絮'}}名称：</label></td>
        ...
        <tr>
            <td class="field_name"><label>{{$lists['func']['url']=='product'?'产品':'花絮'}}链接：</label></td>
            <td class="right">
