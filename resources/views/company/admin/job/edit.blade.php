...
@section('content')
    ...
    <div class="com_admin_list">
        <form data-am-validator method="POST" action="{{DOMAIN_C_BACK}}job/{{$data['id']}}" enctype="multipart/form-data">
            ...
            <table class="table_create">
                ...
                <tr>
                    ...
                    <td class="right">
                        <input type="text" class="field_value" placeholder="数字" pattern="^\d+$" required
                               name="number" value="{{$data['small']}}"/>
                    </td>
                </tr>
