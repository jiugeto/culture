...
@section('content')
    ...
    <div class="com_admin_list">
        <form data-am-validator method="POST" action="{{DOMAIN}}company/admin/firm/{{ $data->id }}" enctype="multipart/form-data">
            ...
            <table class="table_create">
                ...
                <tr>
                    ...
                    <td class="right"><input type="text" class="field_value" placeholder="至少2个字符，多组用|隔开" minlength="2" required name="small"value="{{ $data->small }}"/></td>
                </tr>
