...
@section('content')
    ...
    <div class="com_admin_list">
        <form data-am-validator method="POST" action="{{DOMAIN}}company/admin/video" enctype="multipart/form-data">
            ...
            <table class="table_create">
                ...
                <tr>
                    <td class="field_name"><label>缩略图：</label></td>
                    <td class="right">
                ...
                <tr>
                    ...
                    <td class="right"><input type="text" class="field_value" placeholder="填写视频地址" required name="url"/></td>
                </tr>

                <tr>
                    <td class="field_name"><label>视频介绍：</label></td>
