    ...
    <div class="content">
        ...
        <div class="online">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[1]]}}"
                      onclick="window.location.href='/creation';">>更多</span>
            </p>
        ...
        <div class="trait">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[2]]}}"
                      onclick="window.location.href='/product';">>更多</span>
            </p>
            <div class="trait_con">
                @if(count($goods))
        ...
        {{--<div class="hot">--}}
            {{--<p class="floor">--}}
                ...
                {{--<span class="more" title="更多的{{$floors[$number[3]]}}"--}}
                      {{--onclick="window.location.href='/supply';">>更多</span>--}}
            {{--</p>--}}
            {{--<div class="trait_con">--}}
                {{--@for($i=0;$i<5;++$i)--}}
        ...
        {{--<div class="recommend">--}}
            {{--<p class="floor">--}}
                ...
                {{--<span class="more" title="更多的{{$floors[$number[4]]}}"--}}
                      {{--onclick="window.location.href='/product';">>更多</span>--}}
            {{--</p>--}}
            {{--<div class="trait_con">--}}
                {{--@for($i=0;$i<5;++$i)--}}
        ...
        <div class="demand">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[5]]}}"
                      onclick="window.location.href='/demand';">>更多</span>
            </p>
        ...
        {{--<div class="fun">--}}
            {{--<p class="floor">--}}
                ...
                {{--<span class="more" title="更多的{{$floors[$number[6]]}}"--}}
                      {{--onclick="window.location.href='{{DOMAIN}}entertain';">>更多</span>--}}
            {{--</p>--}}
            {{--<div class="fun_con">--}}
                {{--@for($i=0;$i<5;++$i)--}}
                {{--<div class="img_text">--}}
        ...
        <div class="rent">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[7]]}}"
                      onclick="window.location.href='/rent';">>更多</span>
            </p>
            <div class="rent_con">
                @for($i=0;$i<5;++$i)
                <div class="img_text">
        ...
        <div class="design">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[8]]}}"
                      onclick="window.location.href='/design';">>更多</span>
            </p>
            <div class="design_con">
                <div class="img_text_first">
                    ...
                    {{--<div class="con_text"><a href="">设计设计</a></div>--}}
                </div>
                @for($i=0;$i<8;++$i)
                <div class="img_text">
                    <div class="img">
        ...
        <div class="idea">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[9]]}}"
                      onclick="window.location.href='/idea';">>更多</span>
            </p>
            <div class="idea_con">
                <div class="left">
                    @if(count($ideas))
        ...
        {{--<div class="talk">--}}
            {{--<p class="floor">--}}
                ...
                {{--<span class="more" title="更多的{{$floors[$number[10]]}}"--}}
                      {{--onclick="window.location.href='/talk';">>更多</span>--}}
            {{--</p>--}}
            {{--<div class="talk_con">--}}
                {{--<div class="left">--}}
                    {{--@if(count($talks)>1)--}}
        ...
        <div class="realtime">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[11]]}}"
                      onclick="window.location.href='{{DOMAIN}}order';">>更多</span>
            </p>
        ...
        {{--<div class="cooperation">--}}
            {{--<p class="floor">--}}
                ...
                {{--<span class="more" title="更多的{{$floors[$number[12]]}}"--}}
                      {{--onclick="window.location.href='/coopertion';">>更多</span>--}}
            {{--</p>--}}
        ...
        <div class="voice">
            <p class="floor">
                ...
                <span class="more" title="更多的{{$floors[$number[13]]}}"
                      onclick="window.location.href='{{DOMAIN}}uservoice';">>更多</span>
            </p>
            <div class="voice_con">
