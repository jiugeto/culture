...
@section('content')
    <form action="/login/dologin" method="POST" data-am-validator>
        ...
        <div class="login_div"><input type="password" placeholder="密码(至少6位)" minlength="6" maxlength="20" name="password" required></div>
        <div class="login_div"><input type="password" placeholder="再次输入密码(至少6位)" minlength="6" maxlength="20" name="password2" required></div>
