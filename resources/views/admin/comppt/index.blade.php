            ...
            <div class="am-u-sm-12">
                ...
                @if($datas->total())
                    ...
                    <tr>
                        ...
                        <td class="am-hide-sm-only"><a href="/admin/comppt/{{$data->id}}">
                        ...
                        <td class="am-hide-sm-only">
                            <div class="am-btn-toolbar">
                                ...
                                @if($curr['url']=='')
                                    <a href="/admin/comppt/{{$data->id}}"><button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><img src="/assets/images/show.png" class="icon"> 查看</button></a>
                                    <a href="/admin/comppt/{{$data->id}}/edit"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><img src="/assets/images/edit.png" class="icon"> 编辑</button></a>
