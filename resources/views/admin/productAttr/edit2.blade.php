                ...
                <form class="am-form" data-am-validator method="POST" action="/admin/productattr/{{ $data->id }}" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <span style="float:right;">当前颜色预览<div class="admin_yulan2" style="{{$attrs['color']?'background:'.$attrs['color']:''}}"></div></span>
                            <input type="color" title="点击更改颜色" name="color" value="{{ $attrs['color'] }}">
                        </div>
                        <script>
                            $(document).ready(function(){
                        ...
                        <div class="am-form-group">
                            ...
                            <span style="float:right;">当前颜色预览<div class="admin_yulan3" style="{{$attrs['background']?'background:'.$attrs['background']:''}}"></div></span>
                            <input type="color" title="点击更改颜色" name="background" value="{{ $attrs['background'] }}">
                        </div>
                        <script>
                            $(document).ready(function(){
