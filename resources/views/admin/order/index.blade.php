                        ...
                        <td class="am-hide-sm-only">
                            <div class="am-btn-toolbar">
                                ...
                                @if($curr['url']=='')
                                    ...
                                    {{--<a href="{{DOMAIN}}admin/order/{{$data->id}}/edit"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><img src="{{PUB}}assets/images/edit.png" class="icon"> 编辑</button></a>--}}
