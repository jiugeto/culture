                ...
                @if($datas->total())
                    ...
                    <tr>
                        ...
                        <td class="am-hide-sm-only">
                            <a href="/admin/order/{{$data->id}}">{{ $data->name }}</a>
                        </td>
                        ...
                        <td class="am-hide-sm-only">
                            <div class="am-btn-toolbar">
                                ...
                                @if($curr['url']=='')
                                    <a href="/admin/order/{{$data->id}}"><button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><img src="/assets/images/show.png" class="icon"> 查看</button>
                                    </a>
                                    {{--<a href="/admin/order/{{$data->id}}/edit"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><img src="/assets/images/edit.png" class="icon"> 编辑</button></a>--}}
                                    <a href="/admin/order/{{$data->id}}/destroy"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><img src="/assets/images/forceDelete_red.png" class="icon"> 删除</button></a>
                                @else
                                    <a href="/admin/order/{{$data->id}}/restore"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><img src="/assets/images/edit.png" class="icon"> 还原</button></a>
                                    <a href="/admin/order/{{$data->id}}/forceDelete"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><img src="/assets/images/forceDelete_red.png" class="icon"> 销毁</button></a>
                                @endif
                                </div>
                            </div>
                        </td>
