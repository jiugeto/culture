                ...
                <form class="am-form" data-am-validator method="POST" action="{{DOMAIN}}admin/design/{{$data['id']}}" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="text" placeholder="用户名称" minlength="2" maxlength="20" name="uname" required value="{{UserNameById($data['uid'])}}">
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <textarea name="detail" cols="50" rows="5" required>{{$data['detail']}}</textarea>
                        </div>

                        <div class="am-form-group">
                            <label>价格 / Price：</label>
                            <input type="text" placeholder="正整数" pattern="^\d+$" required name="money" value="{{$data['money']}}"/>
                        </div>
