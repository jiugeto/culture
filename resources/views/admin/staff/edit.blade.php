    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <form class="am-form" data-am-validator method="POST" action="{{PUB}}admin/actor/{{ $data->id }}" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            @foreach($model['hobbys'] as $khobby=>$hobby)
                                <label><input type="checkbox" name="hobby[]" value="{{ $khobby }}" @if($data->getHobby() && in_array($khobby,$data->getHobby())){{'checked'}}@endif/> {{ $hobby }}&nbsp;&nbsp;</label>
                            @endforeach
                        </div>
