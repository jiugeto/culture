                ...
                @if($datas->total())
                    ...
                    <tr>
                        ...
                        <td class="am-hide-sm-only">
                            <a href="{{DOMAIN}}admin/orderfirm/{{$data->id}}">{{ $data->name }}</a></td>
                        ...
                        <td class="am-hide-sm-only">{{ $data->del ? '<span style="color:red;">已删除</span>' :'未删除' }}</td>
...
{{--                                @if($curr['url']=='')--}}
                                    ...
                                    <a href="{{DOMAIN}}admin/opinions/{{$data->id}}/destroy"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><img src="{{PUB}}assets/images/forceDelete_red.png" class="icon"> 删除</button></a>
                                {{--@else--}}
