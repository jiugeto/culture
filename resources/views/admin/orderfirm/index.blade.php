                ...
                @if($datas->total())
                    ...
                    <tr>
                        ...
                        <td class="am-hide-sm-only">
                            <a href="/admin/orderfirm/{{$data->id}}">{{ $data->name }}</a></td>
                        ...
                        <td class="am-hide-sm-only">
                            <div class="am-btn-toolbar">
                                ...
                                @if($curr['url']=='')
                                    ...
                                    <a href="/admin/opinions/{{$data->id}}/destroy"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><img src="/assets/images/forceDelete_red.png" class="icon"> 删除</button></a>
                                @else
