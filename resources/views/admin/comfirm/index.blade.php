            ...
            <div class="am-u-sm-12">
                ...
                @if($datas->total())
                    ...
                    <tr>
                        ...
                        <td class="am-hide-sm-only"><a href="/admin/comfirm/{{$data->id}}">{{ $data->name }}</a></td>
                        <td class="am-hide-sm-only">{{ $data->cid ? $data->company()->name : '初始化默认记录' }}</td>
                        ...
                        <td class="am-hide-sm-only">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/admin/comfirm/{{$data->id}}"><button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><img src="/assets/images/show.png" class="icon"> 查看</button></a>
                                {{--@if($crumb['']['url']=='')--}}
