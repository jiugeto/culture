    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <form class="am-form" data-am-validator method="POST" action="{{DOMAIN}}admin/storyboard" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <textarea name="intro" placeholder="" cols="40" rows="5"></textarea>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="text" placeholder="" pattern="^[1-9](\d+)?(.\d+)?$" required name="money"/>
                        </div>
                        ...
                        <div class="am-form-group">
                            <label>排序 / Sort：</label>
                            <input type="text" placeholder="" pattern="^\d+$" name="sort" value="10"/>
                        </div>

                        <div class="am-form-group">
                            <label>最新 / New：</label>
                            <label><input type="radio" class="radio" name="isnew" value="0" checked> 非最新&nbsp;&nbsp;</label>
                            <label><input type="radio" class="radio" name="isnew" value="1"> 最新&nbsp;&nbsp;</label>
                        </div>

                        <div class="am-form-group">
                            <label>热门 / Hot：</label>
                            <label><input type="radio" class="radio" name="ishot" value="0" checked> 非最热&nbsp;&nbsp;</label>
                            <label><input type="radio" class="radio" name="ishot" value="1"> 最热&nbsp;&nbsp;</label>
                        </div>

                        <div class="am-form-group">
                            <label>前台是否显示 / Is Show：</label>
                            <label><input type="radio" class="radio" name="isshow" value="0"> 不显示&nbsp;&nbsp;</label>
                            <label><input type="radio" class="radio" name="isshow" value="1" checked> 显示&nbsp;&nbsp;</label>
                        </div>
