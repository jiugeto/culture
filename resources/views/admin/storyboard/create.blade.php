                ...
                <form class="am-form" data-am-validator method="POST" action="{{DOMAIN}}admin/storyboard" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <label><input type="radio" class="radio" name="genre"
                                          value="{{$k}}" {{$k==1?'checked':''}}/>
                                {{$vgenre}}&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            @endforeach
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <label><input type="radio" class="radio" name="cate"
                                          value="{{$k}}" {{$k==1?'checked':''}}/>
                                {{ $vcate }}&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            @endforeach
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <textarea name="intro" placeholder="" cols="40" rows="5" required></textarea>
                        </div>

                        <div class="am-form-group">
                            <label>详情内容 / Detail：</label>
                            <textarea name="detail" placeholder="" cols="40" rows="10" required></textarea>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="text" placeholder="" pattern="^\d+$" required name="money"/>
                        </div>

                        <div class="am-form-group">
                            <label>发布方 / User Name：</label>
                            <input type="text" placeholder="用户昵称" minlength="2" maxlength="20" required name="uname"/>
                        </div>
