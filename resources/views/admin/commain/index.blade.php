                ...
                @if(count($datas))
                    ...
                    <tr>
                        ...
                        <td class="am-hide-sm-only">
                            @if($data['logo'])<img src="{{$data['logo']}}" width="30">@else/@endif
                        </td>
                        ...
                        <td class="am-hide-sm-only">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <a href="javascript:;" onclick="getThumb({{$data['id']}})"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><img src="{{PUB}}assets/images/edit.png" class="icon"> logo</button></a>
