    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <form class="am-form" data-am-validator method="POST" action="{{DOMAIN}}admin/{{$attr->id}}/proLayer" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="text" placeholder="" pattern="^\d+$" required name="timelong"/>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="text" placeholder="数字，不填为0" pattern="^\d+$" name="delay"/>
                        </div>
