...
class ApiStoryBoard
{
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/storyboard/show';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, array(
            'id'    =>  $id,
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/storyboard/add';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/storyboard/modify';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, $data);
        $response = json_decode($curl->response);
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/storyboard/setthumb';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, $data);
        $response = json_decode($curl->response);
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/storyboard/setshow';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, array(
            'id'    =>  $id,
