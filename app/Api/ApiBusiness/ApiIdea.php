...
class ApiIdea
{
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/idea/show';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, array(
            'id'    =>  $id,
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/idea/add';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/idea/modify';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, $data);
        $response = json_decode($curl->response);
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/idea/setshow';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, array(
            'id'    =>  $id,
    ...
    {
        $apiUrl = ApiBase::getApiCurl() . '/api/v1/idea/getmodel';
        $curl = new Curl();
        $curl->setHeader('X-Authorization', ApiBase::getApiKey());
        $curl->post($apiUrl, array(
        ));
