...
class ProductLayerModel extends BaseModel
{
    ...
    protected $fillable = [
        'id','name','layer_name','productid','attrid','conStr','layerAttr','timeCurr','animation_name','duration','function','delay','count','direction','state','mode','field','per','value','intro','del','created_at','updated_at',
    ];
    //速度曲线
    protected $functions = [
