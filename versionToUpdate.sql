...
-- 2017-03-13
-- 关于主体业务交易逻辑分析：
-- 可以修改为：客户上传样品、制作要求，平台备份；供应方给出方案，客户确定方案并支付预付款到平台，平台备份方案和预付款；产品完成后交客户预览，客户确定，付清余款到平台；供应方出成品给客户，平台打款到供应方。
-- 假如发生纠纷:客户、或供应方申请平台介入，平台根据备份的样品、方案、预付款判断是非，错误方承担10%的违约金：供应方错误，平台直接退款到客户；客户错误，平台扣除10%作为违约金给供应方，其余款退给客户


-- 2017-03-27
-- 保质保量，会员技术支持、免费咨询、促销打折，Q群交流，客户回访...