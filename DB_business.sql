...
CREATE TABLE `ba_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='系统管理员权限表';
...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_pics` VALUES (1,1,'图片111','/uploads/images/2016-04-28/5721d869932b1.png','ergdfbghrgtfh\r\n111111111111',0,'0000-00-00 00:00:00','2016-04-30 13:55:08');
...
--
-- Table structure for table `com_firms待删`
--

DROP TABLE IF EXISTS `com_firms待删`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `com_firms待删` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  ...
  `pic_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '图片id',
  `detail` varchar(255) NOT NULL COMMENT '细节详情',
  `small` varchar(255) NOT NULL COMMENT '标题小字，多个用|隔开',
  `sort` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '排序字段，值越大越靠前，默认10',
  `sort2` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '用户企业控制排序，值越大越靠前，默认10',
  `isshow` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '系统后台控制是否显示：0不显示，1显示',
  `isshow2` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '用户的公司后台控制是否显示：0不显示，1显示',
  `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='企业服务功能表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `com_firms待删`
--

LOCK TABLES `com_firms待删` WRITE;
/*!40000 ALTER TABLE `com_firms待删` DISABLE KEYS */;
INSERT INTO `com_firms待删` VALUES (1,'服务11',0,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题11',1,'沃尔特Yui欧佩克脚后跟范德萨','小字11',10,10,1,1,'2016-05-01 07:40:27','0000-00-00 00:00:00'),(2,'服务11',0,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题22',1,'们班v查实的风格会尽快咯留一天热','小字22',10,10,1,1,'2016-05-01 07:41:02','0000-00-00 00:00:00'),(3,'服务11',0,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题33',1,'破亿与太热瓦斯的风格和进口量','小字33',10,10,1,1,'2016-05-01 07:41:27','0000-00-00 00:00:00'),(4,'服务11',1,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题11',1,'沃尔特Yui欧佩克脚后跟范德萨','小字11',10,10,1,1,'2016-05-01 07:42:46','0000-00-00 00:00:00'),(5,'服务11',1,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题22',1,'们班v查实的风格会尽快咯留一天热','小字22',10,10,1,1,'2016-05-01 07:42:46','0000-00-00 00:00:00'),(6,'服务11',1,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题33',1,'破亿与太热瓦斯的风格和进口量','小字33',10,10,1,1,'2016-05-01 07:42:46','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `com_firms待删` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `com_funcs` (
  ...
  `genre` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '模块类型：1默认模块，2新加单页',
  `pic_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '图片id',
  `intro` varchar(2000) NOT NULL COMMENT '详情',
  `small` varchar(255) NOT NULL COMMENT '小字',
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='企业功能表 com_funcs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `com_funcs` VALUES (1,'公司简介',0,1,1,0,'<p>vrbggtrhjytjty&nbsp;</p>','',10,1,'2016-05-04 06:33:57','0000-00-00 00:00:00'),(2,'公司历程',0,1,1,0,'<p>简介简介简介简介简介</p>','',10,1,'2016-05-04 09:49:18','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `com_funcs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `com_infos待删`
--

DROP TABLE IF EXISTS `com_infos待删`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `com_infos待删` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  `cid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司id',
  ...
  `pic` varchar(255) NOT NULL COMMENT '图片集合id，多组用|隔开',
  `sort` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '排序字段，值越大越靠前，默认10',
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='企业信息功能表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `com_infos待删`
--

LOCK TABLES `com_infos待删` WRITE;
/*!40000 ALTER TABLE `com_infos待删` DISABLE KEYS */;
INSERT INTO `com_infos待删` VALUES (1,'公司介绍111',1,1,'<p>bhrtbvrhvbguerighuregjghjffjhjfhgjhjghfjhgjhjgfgfsdsfdsgdfgfdhdfghdfhgdfghdfhgdfgdfgfdgdfg</p>','',10,10,1,1,0,0,'2016-04-28 08:07:21','2016-04-28 08:57:09'),(2,'资质荣誉',0,2,'<p>荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉</p><p>荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉</p><p>荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉</p><p>荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉</p><p>荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉荣誉</p>','',10,10,1,1,0,0,'2016-04-28 08:58:59','0000-00-00 00:00:00'),(3,'历程333',0,3,'<p>历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程</p><p>历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程</p><p>历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程</p><p>历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程</p><p>历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程历程</p>','',10,10,1,1,0,0,'2016-04-28 08:59:48','0000-00-00 00:00:00'),(4,'公司新闻',0,4,'<p>公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻</p><p>公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻</p><p>公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻</p><p>公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻</p><p>公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻公司新闻</p>','',10,10,1,1,0,0,'2016-04-28 09:00:33','0000-00-00 00:00:00'),(5,'行业资讯',0,5,'<p>行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯</p><p>行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯</p><p>行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯</p><p>行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯</p><p>行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯行业资讯</p>','',10,10,1,1,0,0,'2016-04-28 09:01:09','0000-00-00 00:00:00'),(6,'团队',0,6,'<p>团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队</p><p>团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队</p><p>团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队</p><p>团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队</p><p>团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队团队</p>','1',10,10,1,1,0,0,'2016-04-28 09:01:52','2016-04-29 09:07:24'),(9,'公司新闻',1,4,'','',10,10,1,1,0,0,'2016-05-01 09:25:45','0000-00-00 00:00:00'),(10,'行业资讯',1,5,'','',10,10,1,1,0,0,'2016-05-01 09:25:45','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `com_infos待删` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `com_jobs待删`
--

DROP TABLE IF EXISTS `com_jobs待删`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `com_jobs待删` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `cid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司id',
  `name` varchar(255) NOT NULL COMMENT '招聘名称',
  `intro` varchar(1000) NOT NULL COMMENT '介绍',
  `job` varchar(255) NOT NULL COMMENT '岗位需求',
  `num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '岗位所需人数',
  `require` varchar(255) NOT NULL COMMENT '岗位的要求',
  `sort` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '排序字段，值越大越靠前，默认10',
  `sort2` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '用户企业控制排序，值越大越靠前，默认10',
  `istop` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否置顶：0不置顶，1置顶',
  `istop2` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否置顶：0不置顶，1置顶',
  `isshow` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '系统后台控制是否显示：0不显示，1显示',
  `isshow2` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '用户的公司后台控制是否显示：0不显示，1显示',
  `del` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '回收站：0不删除，1删除',
  `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
...
--
-- Dumping data for table `com_jobs待删`
--

LOCK TABLES `com_jobs待删` WRITE;
/*!40000 ALTER TABLE `com_jobs待删` DISABLE KEYS */;
INSERT INTO `com_jobs待删` VALUES (1,0,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','某某岗位',1,'某某岗位要求',10,10,0,0,1,1,0,'2016-04-27 00:00:00','2016-04-27 00:00:00'),(2,0,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','工作22',2,'工作要求工作要求工作要求工作要求工作要求工作要求工作要求工作要求',10,10,0,0,1,1,0,'2016-05-02 02:05:41','2016-05-02 02:33:51'),(3,1,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','某某岗位',1,'某某岗位要求',10,10,0,0,1,1,0,'2016-05-02 17:20:32','0000-00-00 00:00:00'),(4,1,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','工作22',2,'工作要求工作要求工作要求工作要求工作要求工作要求工作要求工作要求',10,10,0,0,1,1,0,'2016-05-02 17:20:32','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `com_jobs待删` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `com_main` (
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='企业信息主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `com_main` VALUES (1,0,0,'','某某公司','某某关键字','某某描述','',10,0,1,'2016-04-27 00:00:00','2016-04-27 00:00:00');
...
CREATE TABLE `com_modules` (
  ...
  `cid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司id',
  `genre` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '模块类型：1默认模块，23新加单页',
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='企业模块表 com_modules';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `com_modules` VALUES (1,'关于公司',0,1,'<p>ggggggggggggggggggggggggggggg</p>',10,1,'2016-05-04 06:33:29','0000-00-00 00:00:00'),(2,'服务项目',0,1,'<p>服务服务服务服务服务服务服务</p>',10,1,'2016-05-04 09:44:15','0000-00-00 00:00:00'),(3,'团队',0,1,'<p>团队团队团队团队团队团队团队团队团队</p>',10,1,'2016-05-04 09:44:52','0000-00-00 00:00:00'),(4,'招聘',0,1,'<p>招聘招聘招聘招聘招聘招聘招聘招聘</p>',10,1,'2016-05-04 09:45:11','0000-00-00 00:00:00'),(5,'联系方式',0,1,'<p>联系联系联系联系联系联系联系联系</p>',10,1,'2016-05-04 09:45:35','0000-00-00 00:00:00');
...
--
-- Table structure for table `com_singles待删`
--

DROP TABLE IF EXISTS `com_singles待删`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `com_singles待删` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  `cid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司id',
  `cate` varchar(255) NOT NULL COMMENT '单页类型',
  `intro` varchar(2000) NOT NULL COMMENT '详情介绍',
  `sort` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '排序字段，值越大越靠前，默认10',
  `sort2` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '用户企业控制的排序，值越大越靠前，默认10',
  `isshow` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '系统后台控制是否显示：0不显示，1显示',
  ...
  `updated_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='企业功能扩展表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `com_singles待删`
--

LOCK TABLES `com_singles待删` WRITE;
/*!40000 ALTER TABLE `com_singles待删` DISABLE KEYS */;
/*!40000 ALTER TABLE `com_singles待删` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `companys` (
  ...
  `areacode` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '区号',
...
INSERT INTO `companys` VALUES (1,'这是广告公司',10,'滨盛路1870','0123456789012345',1,571,88888888,100000,'www.jiuge.com',12345678,311301,'123@456.com',10,'2016-04-28','0000-00-00');
...
-- Dump completed on 2016-05-04 18:07:45
