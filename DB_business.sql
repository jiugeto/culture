...
CREATE TABLE `ba_userlog` (
  ...
  `created_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_com_functions` (
  ...
  `updated_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='企业所有功能表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-04-26 16:41:19
