...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_products_layer` VALUES (1,'动画',1,1,'','','my',1.50,1,0.00,1,1,0,1,'',0,'2016-05-09','0000-00-00'),(2,'动画2',1,5,'','','my2',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','2016-05-10'),(3,'动画3',1,5,'','','my3',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(4,'动画4',1,5,'','','my4',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(5,'动画5',1,5,'','','my5',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(6,'动画6',1,5,'','','my6',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(7,'动画7',1,5,'','','my7',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00');
...
-- Dump completed on 2016-05-29 23:00:13
