...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_products` (
  ...
  `width` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '动画宽比率，单位px',
  `height` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '动画高比率，单位px',
