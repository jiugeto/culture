...
CREATE TABLE `bs_menus` (
  ...
  `updated_at` date NOT NULL DEFAULT '0000-00-00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='前台左侧菜单控制表 bs_menus';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_products_con` VALUES (1,1,0,'',0,0,'','','',960,540,'',0,0,0,0,0,'','',10,1,0,'2016-05-09','0000-00-00'),(2,1,1,'',1,1,'','','',0,0,'#000000',0,0,0,0,0,'a:6:{s:5:\"color\";s:7:\"#000000\";s:9:\"font_size\";s:2:\"16\";s:12:\"word_spacing\";s:0:\"\";s:11:\"line_height\";s:0:\"\";s:14:\"text_transform\";s:1:\"0\";s:10:\"text_align\";s:1:\"0\";}','',10,1,0,'2016-05-11','0000-00-00');
...
CREATE TABLE `bs_products_layer` (
  ...
  `duration` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '动画时长，单位秒(s)',
  ...
  `delay` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '开始延时秒数s',
