...
CREATE TABLE `bs_menus` (
  ...
  `updated_at` date NOT NULL DEFAULT '0000-00-00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='前台左侧菜单控制表 bs_menus';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_pics` (
  ...
  `times` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '使用次数',
...
INSERT INTO `bs_pics` VALUES (1,1,'图片001','http://img0.bdstatic.com/img/image/lvyou/liushishi1.jpg','',0,0,'2016-04-24 14:16:34','0000-00-00 00:00:00');
...
-- Dump completed on 2016-04-24 23:26:42
