...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_products_con` (
  ...
  `position` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '定位：static无，absolute绝对定位(相对于第一个父级)，fixed绝对定位(相对于浏览器)，relative相对定位，inherit继承上级',
...
-- Dump completed on 2016-05-24 18:58:21
