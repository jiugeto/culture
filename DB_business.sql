...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `bs_com_firms`
--

DROP TABLE IF EXISTS `bs_com_firms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bs_com_firms` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
...
--
-- Dumping data for table `bs_com_firms`
--

LOCK TABLES `bs_com_firms` WRITE;
/*!40000 ALTER TABLE `bs_com_firms` DISABLE KEYS */;
INSERT INTO `bs_com_firms` VALUES (1,'服务11',0,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题11',1,'沃尔特Yui欧佩克脚后跟范德萨','小字11',10,10,1,1,'2016-05-01 07:40:27','0000-00-00 00:00:00'),(2,'服务11',0,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题22',1,'们班v查实的风格会尽快咯留一天热','小字22',10,10,1,1,'2016-05-01 07:41:02','0000-00-00 00:00:00'),(3,'服务11',0,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题33',1,'破亿与太热瓦斯的风格和进口量','小字33',10,10,1,1,'2016-05-01 07:41:27','0000-00-00 00:00:00'),(4,'服务11',1,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题11',1,'沃尔特Yui欧佩克脚后跟范德萨','小字11',10,10,1,1,'2016-05-01 07:42:46','0000-00-00 00:00:00'),(5,'服务11',1,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题22',1,'们班v查实的风格会尽快咯留一天热','小字22',10,10,1,1,'2016-05-01 07:42:46','0000-00-00 00:00:00'),(6,'服务11',1,'<p>QWERTYUI离开家很过分的筛选出v不能</p>','标题33',1,'破亿与太热瓦斯的风格和进口量','小字33',10,10,1,1,'2016-05-01 07:42:46','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `bs_com_firms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bs_com_infos`
--

DROP TABLE IF EXISTS `bs_com_infos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bs_com_infos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  `cid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司id',
...
--
-- Dumping data for table `bs_com_jobs`
--

LOCK TABLES `bs_com_jobs` WRITE;
/*!40000 ALTER TABLE `bs_com_jobs` DISABLE KEYS */;
INSERT INTO `bs_com_jobs` VALUES (1,0,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','某某岗位',1,'某某岗位要求',10,10,0,0,1,1,0,'2016-04-27 00:00:00','2016-04-27 00:00:00'),(2,0,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','工作22',2,'工作要求工作要求工作要求工作要求工作要求工作要求工作要求工作要求',10,10,0,0,1,1,0,'2016-05-02 02:05:41','2016-05-02 02:33:51'),(3,1,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','某某岗位',1,'某某岗位要求',10,10,0,0,1,1,0,'2016-05-02 17:20:32','0000-00-00 00:00:00'),(4,1,'挂号费和法国','sdfghjjhertyuikkjmnb v fgtyyjuhngbvd','工作22',2,'工作要求工作要求工作要求工作要求工作要求工作要求工作要求工作要求',10,10,0,0,1,1,0,'2016-05-02 17:20:32','0000-00-00 00:00:00');
/*!40000 ALTER TABLE `bs_com_jobs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bs_com_main`
--

DROP TABLE IF EXISTS `bs_com_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bs_com_main` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bs_com_main`
--

LOCK TABLES `bs_com_main` WRITE;
/*!40000 ALTER TABLE `bs_com_main` DISABLE KEYS */;
INSERT INTO `bs_com_main` VALUES (1,0,0,'','某某公司','某某关键字','某某描述','',10,0,1,'2016-04-27 00:00:00','2016-04-27 00:00:00');
/*!40000 ALTER TABLE `bs_com_main` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bs_com_ppts`
--

DROP TABLE IF EXISTS `bs_com_ppts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bs_com_ppts` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bs_com_ppts`
--

LOCK TABLES `bs_com_ppts` WRITE;
/*!40000 ALTER TABLE `bs_com_ppts` DISABLE KEYS */;
INSERT INTO `bs_com_ppts` VALUES (1,1,0,'玩儿体育','##',10,10,1,0,0,'2016-05-01','0000-00-00'),(2,1,0,'铭播放v对方更不能吃','##',10,10,1,0,0,'2016-05-01','0000-00-00'),(3,1,0,'内部v查询速度法国红酒','##',10,10,1,0,0,'2016-05-01','0000-00-00'),(4,1,1,'玩儿体育','##',10,10,1,0,0,'2016-05-01','0000-00-00'),(5,1,1,'铭播放v对方更不能吃','##',10,10,1,0,0,'2016-05-01','0000-00-00'),(6,1,1,'内部v查询速度法国红酒','##',10,10,1,0,0,'2016-05-01','0000-00-00');
/*!40000 ALTER TABLE `bs_com_ppts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bs_com_singles`
--

DROP TABLE IF EXISTS `bs_com_singles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bs_com_singles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  `cid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司id',
...
--
-- Dumping data for table `bs_com_singles`
--

LOCK TABLES `bs_com_singles` WRITE;
/*!40000 ALTER TABLE `bs_com_singles` DISABLE KEYS */;
/*!40000 ALTER TABLE `bs_com_singles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-03 18:36:44
