...
CREATE TABLE `ba_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='系统管理员权限表';
...
-- Dump completed on 2016-04-16 19:34:51
