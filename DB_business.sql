...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `com_funcs` (
  ...
  `type` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '功能类型：1简介，2历程，3服务，4团队，5招聘，6联系，7新闻，8资讯',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='企业功能表 com_funcs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-05 18:25:34
