...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_products_attr` (
  ...
  `style_name` varchar(10) NOT NULL COMMENT '类样式名称，加个前缀好区分',
  ...
  `updated_at` date NOT NULL DEFAULT '0000-00-00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='在线创作div类样式属性表：在线写的属性';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_products_attr` VALUES (1,'测试属性1','attr_attr_',1,0,'auto-auto','auto-auto',0,0,'','#000000',0,0,0,0,0,'#000000',0,0,0,0,0,' ',0,0,'2016-05-09','2016-05-09');
...
INSERT INTO `bs_products_layer` VALUES (1,'动画',1,1,'my',5,1,0,1,1,0,1,'top|left|','','0|100|10|20|','',0,'2016-05-09','0000-00-00');
...
-- Dump completed on 2016-05-09 23:36:43
