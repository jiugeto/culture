...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_products_con` VALUES (1,'',0,1,0,'','','',960,540,'',0,0,0,0,0,'','',10,1,0,'2016-05-09','0000-00-00');
...
-- Dump completed on 2016-05-10 22:08:35
