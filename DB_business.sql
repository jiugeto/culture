...
CREATE TABLE `ba_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='系统管理员权限表';
...
CREATE TABLE `ba_userlog` (
  ...
  `created_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `bs_com_extends`
--

DROP TABLE IF EXISTS `bs_com_extends`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bs_com_extends` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
...
--
-- Dumping data for table `bs_com_extends`
--

LOCK TABLES `bs_com_extends` WRITE;
/*!40000 ALTER TABLE `bs_com_extends` DISABLE KEYS */;
/*!40000 ALTER TABLE `bs_com_extends` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `bs_com_firms` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='企业服务功能表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_com_firms` VALUES (1,'服务11',1,'<p>wertyuiouytre让他Yui开奖号股份的的方法赶回家看看就换个房地产v办没办v程序v不帮你看巨化股份嘚瑟日同仁医院</p><p>阿斯顿法国和555555555555555555555555</p>','标题11',1,'我一与他惹我认同与亿聚合股份的','小字11|yyyyyy',10,10,1,1,'2016-04-28 00:00:00','2016-04-30 12:13:19'),(2,'服务11',0,'<p>wertyuiouytre让他Yui开奖号股份的的方法赶回家看看就换个房地产v办没办v程序v不帮你看巨化股份嘚瑟日同仁医院</p><p>阿斯顿法国和555555555555555555555555</p>','标题22',1,'grethyjgfhytgjnhgmghjnfg','小字22',10,10,1,1,'2016-04-29 14:16:40','0000-00-00 00:00:00'),(3,'服务11',0,'<p>wertyuiouytre让他Yui开奖号股份的的方法赶回家看看就换个房地产v办没办v程序v不帮你看巨化股份嘚瑟日同仁医院</p><p>阿斯顿法国和555555555555555555555555</p>','标题33',1,'tjnuykthiuuytrewsdfghjgfxcvb','小字33',10,10,1,1,'2016-04-29 14:19:53','0000-00-00 00:00:00');
...
-- Dump completed on 2016-04-30 23:10:40
