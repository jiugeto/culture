...
CREATE TABLE `com_funcs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='企业功能表 com_funcs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-05 10:44:23
