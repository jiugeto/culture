...
CREATE TABLE `bs_ideas_read` (
  ...
  `created_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='创意阅读表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_orders` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='订单表 bs_orders';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_orders` VALUES (2,'创意123456','201607031309426817',1,3,1,'jiuge',2,'jiuge2',0,20,0,0,0,0,7,'',1,0,'2016-07-03 13:09:42','2016-07-03 16:49:32','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00');
...
-- Dump completed on 2016-07-05 17:46:42
