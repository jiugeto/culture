...
CREATE TABLE `bs_orders_pro` (
  ...
  `status` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单状态：申请，确定，付款，管理员处理，结果',
  `isshow` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '前台列表是否显示：0不显示，1显示，默认1',
  `del` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '回收站：0不删除，1删除',
  `created_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '创建时间',
  `updated_at` date NOT NULL DEFAULT '0000-00-00',
...
INSERT INTO `bs_products_layer` VALUES (1,'动画',1,1,'','',1,'act_1_1_1',1.50,1,0.00,1,1,0,1,'',0,'2016-05-09','0000-00-00'),(2,'动画2',1,5,'','',0,'my2',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','2016-05-10'),(3,'动画3',1,5,'','',0,'my3',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(4,'动画4',1,5,'','',0,'my4',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(5,'动画5',1,5,'','',0,'my5',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(6,'动画6',1,5,'','',0,'my6',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00'),(7,'动画7',1,5,'','',0,'my7',5.00,1,0.00,1,1,0,1,'',0,'2016-05-10','0000-00-00');
...
-- Dump completed on 2016-06-05 20:30:22
