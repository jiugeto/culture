...
CREATE TABLE `ba_userlog` (
  ...
  `created_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_com_firms` (
  ...
  `updated_at` date NOT NULL DEFAULT '0000-00-00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='企业服务功能表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bs_com_firms` VALUES (1,'服务11',0,'<p>wertyuiouytre让他Yui开奖号股份的的方法赶回家看看就换个房地产v办没办v程序v不帮你看巨化股份嘚瑟日同仁医院</p><p>阿斯顿法国和555555555555555555555555</p>','标题11',1,'我一与他惹我认同与亿聚合股份的','小字11',10,1,0,'2016-04-28','2016-04-28');
...
-- Dump completed on 2016-04-29 18:33:35
