...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `com_funcs` (
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='企业功能表 com_funcs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `com_funcs` VALUES (1,'公司简介',0,1,1,0,'<p>vrbggtrhjytjty&nbsp;</p>','',10,1,'2016-05-04 06:33:57','0000-00-00 00:00:00');
...
CREATE TABLE `com_modules` (
  ...
  `updated_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='企业模块表 com_modules';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `com_modules` VALUES (1,'关于公司',0,1,'<p>ggggggggggggggggggggggggggggg</p>',10,1,'2016-05-04 06:33:29','0000-00-00 00:00:00');
...
-- Dump completed on 2016-05-04 15:38:28
