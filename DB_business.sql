...
CREATE TABLE `ba_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='系统管理员权限表';
...
CREATE TABLE `ba_userlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='用户日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bs_com_main` (
  ...
  `job` varchar(1000) NOT NULL COMMENT '岗位需求，序列化存储',
  `job_num` varchar(255) NOT NULL COMMENT '岗位所需人数,多组用|隔开',
  `job_require` varchar(2000) NOT NULL COMMENT '岗位的要求',
  `sort` int(10) unsigned NOT NULL DEFAULT '10' COMMENT '排序字段，值越大越靠前，默认10',
...
INSERT INTO `bs_com_main` VALUES (1,0,0,'','某某公司','某某关键字','某某描述','','某某岗位|后期','1|2','某某岗位要求|熟练一些特效软件',10,0,1,0,'2016-04-27 00:00:00','2016-04-27 00:00:00');
...
CREATE TABLE `bs_pics` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='图片管理表（暂用QQ空间相册）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-01 18:09:42
